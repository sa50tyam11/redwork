  ...
  return (
    <section className="relative w-full h-[100svh] bg-[#080808] overflow-hidden selection:bg-[#e8251a] selection:text-[#fff]">
        ...
        <div className="absolute top-0 left-0 w-full h-10 md:h-12 flex z-40 border-b-2 border-white/20 font-mono text-base md:text-xl">
          <div className="bg-[#111111] text-white px-4 md:px-8 py-2 flex items-center border-r-2 border-white/20 w-auto whitespace-nowrap tracking-wide font-bold">
            Redwork Studio
          </div>
          <div className="bg-[#0e0e0e] text-[#f0ede8] px-4 md:px-6 py-2 flex-grow flex items-center justify-center border-r-2 border-white/20 text-center whitespace-nowrap overflow-hidden text-ellipsis">
            <AnimatePresence mode="wait">
              <motion.span
                ...
                className="text-[#f0ede8] font-ui text-sm font-semibold tracking-wider"
              >
                {captions[captionIndex]}
              </motion.span>
            </AnimatePresence>
          </div>
          <Link to="/contact" className="bg-[#e8251a] text-white hover:bg-[#ff3326] transition-colors px-6 md:px-8 py-2 flex items-center font-ui font-bold tracking-widest uppercase text-xs md:text-sm cursor-pointer hidden sm:flex group">
            Start Project
